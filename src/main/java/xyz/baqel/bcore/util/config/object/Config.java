package xyz.baqel.bcore.util.config.object;
...
public class Config extends YamlConfiguration {
     ...
     */
    private Config(JavaPlugin plugin, String fileName, String fileExtension) {
        this.plugin = plugin;
    ...
    public boolean equals(Object o) {
        ...
        if (!Objects.equals(fileName, config.fileName)) return false;
        return Objects.equals(plugin, config.plugin);
    }
