package xyz.baqel.bcore.util.object.particle;
...
//        return new PacketPlayOutWorldParticles(EnumParticle.valueOf(this.name()), false, x, y, z, offsetX, offsetY, offsetZ, speed, amount);
//    }
}