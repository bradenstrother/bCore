...
public class InventoryUtil {
    ...
    public static int MINIMUM_INVENTORY_SIZE = MINIMUM_INVENTORY_HEIGHT * DEFAULT_INVENTORY_WIDTH;

    public static int MAXIMUM_INVENTORY_HEIGHT = 6;
    public static int MAXIMUM_INVENTORY_SIZE = MAXIMUM_INVENTORY_HEIGHT * DEFAULT_INVENTORY_WIDTH;

    public static int MAXIMUM_SINGLE_CHEST_SIZE = DEFAULT_INVENTORY_WIDTH * 3;
    public static int MAXIMUM_DOUBLE_CHEST_SIZE = MAXIMUM_SINGLE_CHEST_SIZE * 2;
